...
x=A\b
display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
display('Solucio del sistema usant Gauss-Seidel:')
x0=b;
[xansJ,iterJ]=gs(A,b,x0);
xansJ;
fout=fopen('solucionsDirecteGS.res','w')
fprintf(fout,'Usant Resolucio Directa \t\t Gauss-Seidel\n');
for i=1:n
