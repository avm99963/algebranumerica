...
int main(int argc, char *argv[]) {
  ...
  cout << "Nombres de condicionament d'A: K_1=" << condition_number_1(A, inv_A, n) << ", K_inf=" << condition_number_inf(A, inv_A, n) << "\n";
  ...
  cout << "Nombres de condicionament de L: K_1=" << condition_number_1(L, inv_L, n) << ", K_inf=" << condition_number_inf(L, inv_L, n) << "\n";
  cout << "Nombres de condicionament de U: K_1=" << condition_number_1(U, inv_U, n) << ", K_inf=" << condition_number_inf(U, inv_U, n) << "\n";
}
